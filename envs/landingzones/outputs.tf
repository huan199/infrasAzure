output "vnet_peering_ids" {
  ...
  value = module.vnetpeering.vnet_peering_ids
}

output "vnet_peering_names" {
  description = "Names of the created virtual network peerings."
  value = module.vnetpeering.vnet_peering_names
}
...
output "storage_account_ids" {
  ...
  value = module.azure-storage.storage_account_ids
}

output "storage_account_names" {
  description = "Names of the created storage accounts."
  value = module.azure-storage.storage_account_names
}
