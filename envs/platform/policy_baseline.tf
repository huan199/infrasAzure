...
########################
variable "mg_id" {
  description = "Name của Management Group (Platform)"
  type        = string
  default     = "Platform"
}
...
# Platform: KHÔNG chặn tạo Public IP resource
...
########################
# 3) (Tuỳ chọn) Custom: Deny tạo Public IP resource
#    Platform để FALSE (không tạo assignment này)
########################
